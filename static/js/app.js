...
//clearing the existing data/create a blank canvas
...
function handleClick() {
  ...
  if (date) {
    ...
    //rebuild the table using the filteted data.if no date was entered, then filteredData will just be the original tableData.
